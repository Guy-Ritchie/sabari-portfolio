...
type MediaPostsDocumentDataSlicesSlice = ImageBlockSlice | TextBlockSlice;

/**
 * Content for Media Post documents
 */
interface MediaPostsDocumentData {
  /**
   * Title field in *Media Post*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: media_posts.title
   * - **Tab**: Main
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
  ...
  /**
   * Date field in *Media Post*
   *
   * - **Field Type**: Date
   * - **Placeholder**: *None*
   * - **API ID Path**: media_posts.date
   * - **Tab**: Main
  ...
  /**
   * Hover Image field in *Media Post*
   *
   * - **Field Type**: Image
   * - **Placeholder**: *None*
   * - **API ID Path**: media_posts.hover_image
   * - **Tab**: Main
   * - **Documentation**: https://prismic.io/docs/field#image
   */
  ...
  /**
   * Slice Zone field in *Media Post*
   *
   * - **Field Type**: Slice Zone
   * - **Placeholder**: *None*
   * - **API ID Path**: media_posts.slices[]
   * - **Tab**: Main
   * - **Documentation**: https://prismic.io/docs/field#slices
   */
  slices: prismic.SliceZone<MediaPostsDocumentDataSlicesSlice> /**
   * Meta Title field in *Media Post*
   *
   * - **Field Type**: Text
   * - **Placeholder**: A title of the page used for social media and search engines
   * - **API ID Path**: media_posts.meta_title
   * - **Tab**: SEO & Metadata
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */;
  meta_title: prismic.KeyTextField;
  ...
  /**
   * Meta Description field in *Media Post*
   *
   * - **Field Type**: Text
   * - **Placeholder**: A brief summary of the page
   * - **API ID Path**: media_posts.meta_description
   * - **Tab**: SEO & Metadata
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
  meta_description: prismic.KeyTextField;
  ...
  /**
   * Meta Image field in *Media Post*
   *
   * - **Field Type**: Image
   * - **Placeholder**: *None*
   * - **API ID Path**: media_posts.meta_image
   * - **Tab**: SEO & Metadata
   * - **Documentation**: https://prismic.io/docs/field#image
   */
  meta_image: prismic.ImageField<never>;
...
/**
 * Media Post document from Prismic
 *
 * - **API ID**: `media_posts`
 * - **Repeatable**: `true`
 * - **Documentation**: https://prismic.io/docs/custom-types
 ...
 * @typeParam Lang - Language API ID of the document.
 */
export type MediaPostsDocument<Lang extends string = string> =
  prismic.PrismicDocumentWithUID<
    Simplify<MediaPostsDocumentData>,
    "media_posts",
    Lang
  >;
...
export interface ContentIndexSliceDefaultPrimary {
   ...
   */
  content_type: prismic.SelectField<"Project" | "Posts">;
...
/**
 * Primary content in *SkillList → Primary*
 */
export interface SkillListSliceDefaultPrimary {
  /**
   * Heading field in *SkillList → Primary*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: skill_list.primary.heading
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
  heading: prismic.KeyTextField;
}
...
/**
 * Primary content in *SkillList → Items*
 */
export interface SkillListSliceDefaultItem {
  /**
   * Skill Name field in *SkillList → Items*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: skill_list.items[].skill_name
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
  skill_name: prismic.KeyTextField;

  /**
   * Skill Color field in *SkillList → Items*
   *
   * - **Field Type**: Color
   * - **Placeholder**: *None*
   * - **API ID Path**: skill_list.items[].skill_color
...
/**
 * Default variation for SkillList Slice
 *
 * - **API ID**: `default`
 * - **Description**: Default
 * - **Documentation**: https://prismic.io/docs/slice
 */
export type SkillListSliceDefault = prismic.SharedSliceVariation<
  "default",
  Simplify<SkillListSliceDefaultPrimary>,
  Simplify<SkillListSliceDefaultItem>
>;

/**
 * Slice variation for *SkillList*
 */
type SkillListSliceVariation = SkillListSliceDefault;

/**
 * SkillList Shared Slice
 *
 * - **API ID**: `skill_list`
 * - **Description**: SkillList
 * - **Documentation**: https://prismic.io/docs/slice
 */
export type SkillListSlice = prismic.SharedSlice<
  "skill_list",
  SkillListSliceVariation
>;
...
declare module "@prismicio/client" {
  ...
  namespace Content {
    export type {
      ...
      MediaPostsDocument,
      MediaPostsDocumentData,
      MediaPostsDocumentDataSlicesSlice,
      PageDocument,
      PageDocumentData,
      ...
      SkillListSlice,
      SkillListSliceDefaultPrimary,
      SkillListSliceDefaultItem,
      SkillListSliceVariation,
      SkillListSliceDefault,
      TextBlockSlice,
